...
.all((req,res,next)=>{console.log("Peticion a ruta cliente")})
.get((req,res,next)=>{console.log("Peticion a ruta cliente");res.send("regresando info")})
.put((req,res,next)=>{console.log("Peticion a ruta cliente");res.send("regresando info")})
